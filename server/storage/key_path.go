...
// makeSchemaKey returns the key path to the schema meta info. For example: (cluster1)
//
...
// makeClusterKey returns the cluster meta info key path. For example:
//
...
// makeTableKey returns the table meta info key path. For example: (cluster1, schema1)
//
...
// makeShardTopologyKey returns the shard meta info key path. For example: (cluster1)
//
...
// makeClusterTopologyKey returns the cluster topology meta info key path. For example: (cluster1)
//
...
// makeShardLatestVersionKey returns the latest version info key path of shard. For example: (cluster1)
//
...
// makeNodeKey returns the node meta info key path. For example: (cluster1)
//
...
// makeNameToIDKey return the table id key path. For example: (cluster1, schema1)
//
