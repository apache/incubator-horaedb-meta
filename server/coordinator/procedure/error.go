...
var (
	...
	ErrCreateProcedure       = coderr.NewCodeError(coderr.Internal, "create procedure failed")
	ErrSubmitProcedure       = coderr.NewCodeError(coderr.Internal, "submit procedure failed")
