...
func NewCluster(metadata *metadata.ClusterMetadata, client *clientv3.Client, rootPath string, enableSchedule bool, scheduleType string) (*Cluster, error) {
	...
	schedulerManager := scheduler.NewManager(procedureManager, procedureFactory, metadata, client, rootPath, enableSchedule, scheduleType)
